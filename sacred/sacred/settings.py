"""
Django settings for sacred project.
...
SECRET_KEY = 'django-insecure-lvvwz1&6vy5s=f@^bnn)tiu6*jvr$b8)v#0@l7#$zodm@1y$#s'
...
WSGI_APPLICATION = 'sacred.wsgi.application'
